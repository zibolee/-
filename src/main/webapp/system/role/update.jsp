...
<script type="text/javascript">
		...
		$(function() {
			...
			$.ajax({
				url: "<%=basePath%>/system/rolemodule/getModuleIdsByRoleId",
...
<body>
	...
	<form method="post" action="<%=basePath%>/system/rolemodule/updateRoleModuleRelation" class="form-horizontal" id="addForm">
