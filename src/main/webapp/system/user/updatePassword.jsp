...
<html>
    ...
    $(document).ready(function(){
       ...
       return;
        ...
        $.ajax({type: "post", url: "${pageContext.request.contextPath}/system/user/updatePassword", dataType: "json", data:{"password":password,"oldPassword":oldPassword}, success: function (data) {
        alert(data.msg);  
       // alert("trtrtt");
        }
        });
