...
<body>
	...
	<form action="${pageContext.request.contextPath}//loginfo/listByPage" method="post">
		<div class="row">
			<div class="col-sm-8">
	...
	<p>
		...
		条记录 <a href="listByPage?pageNum=1">第一页</a>
		<c:if test="${pageInfo.hasPreviousPage }">
			<a href="listByPage?pageNum=${pageInfo.pageNum-1}">上一页</a>
		</c:if>

		<c:if test="${pageInfo.hasNextPage }">
			<a href="listByPage?pageNum=${pageInfo.pageNum+1}">下一页</a>
		</c:if>

		<a href="listByPage?pageNum=${pageInfo.pages}">最后页</a>
</body>
</html>
